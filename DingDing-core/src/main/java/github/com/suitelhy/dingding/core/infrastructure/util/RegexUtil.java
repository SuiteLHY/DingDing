 ...
 *
 * @Reference <a href="https://examples.javacodegeeks.com/core-java/util/regex/patternsyntaxexception/java-util-regex-patternsyntaxexception-example/">
...
public final class RegexUtil {
     ...
     * @param regex
     * @param input
     * @return 可为 <code>null</code>, 此时 <param>regex</param> 不符合正则表达式的模式.
     */
    @Nullable
