...
public interface ResourceTask {
     ...
     */
    @NotNull TaskResult<List<ResourceDto>> selectAllResource(int pageIndex, int pageSize, @NotNull AbstractSecurityUser operator);
     ...
     * @return {@link TaskResult}
     */
    @NotNull TaskResult<List<ResourceDto>> selectAllResource(int pageIndex, int pageSize, OAuth2AuthenticationInfo.AbstractUserAuthentication.@NotNull AbstractDetails operator);
