...
public abstract class AbstractWebResult<_STATUS extends VoModel, _DATA, _EXTRA>
     ...
     * }
     */
    protected final @NotNull Map<String, String> requestInfo = new HashMap<String, String>(1) {
        /**
         * 转换为字符串
         *
         * @return 转换结果
     ...
     *
     * @Description
     * · 不要求所有关联的业务都能及时响应[成功的状态], 但一定要保证[当前所执行的业务操作]在预期范围内且[能够保证在预期时间内达到预期成功的结果].
