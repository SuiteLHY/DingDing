...
public interface HTTP<VO extends Enum<VO> & VoModel<VO, V, _DESCRIPTION>, V extends Number, _DESCRIPTION>
    ...
    enum StatusVo
        ...
        , SWITCHING_PROTOCOLS(101
                ...
                , HttpStatus.Series.valueOf(HttpStatus.SWITCHING_PROTOCOLS).name())
        , PROCESSING(102
                , "Processing"
                ...
                , HttpStatus.Series.valueOf(HttpStatus.PROCESSING).name())
        , EARLY_HINTS (103
                , "Early Hints "
        ...
        , OK(200
                ...
                , HttpStatus.OK
                , HttpStatus.Series.valueOf(HttpStatus.OK).name())
        , CREATED(201
                , "Created"
                ...
                , HttpStatus.CREATED
                , HttpStatus.Series.valueOf(HttpStatus.CREATED).name())
        , ACCEPTED(202
                , "Accepted"
                ...
                , HttpStatus.ACCEPTED
                , HttpStatus.Series.valueOf(HttpStatus.ACCEPTED).name())
        , NON_AUTHORITATIVE_INFORMATION(203
                ...
                , HttpStatus.Series.valueOf(HttpStatus.NON_AUTHORITATIVE_INFORMATION).name())
        , NO_CONTENT(204
                , "No Content"
                ...
                , HttpStatus.Series.valueOf(HttpStatus.NO_CONTENT).name())
        , RESET_CONTENT(205
                , "Reset Content"
                ...
                , HttpStatus.Series.valueOf(HttpStatus.RESET_CONTENT).name())
        , PARTIAL_CONTENT(206
                , "Partial Content"
                , "服务器已经成功处理了部分 GET 请求。"
                ...
                , HttpStatus.Series.valueOf(HttpStatus.PARTIAL_CONTENT).name())
        , MULTI_STATUS(207
                , "Multi-Status"
                , "【WebDAV; RFC 4918】代表之后的消息体将是一个 XML 消息，并且[可能依照之前子请求数量的不同，包含一系列独立的响应代码]。"
                , HttpStatus.MULTI_STATUS
                , HttpStatus.Series.valueOf(HttpStatus.MULTI_STATUS).name())
        , ALREADY_REPORTED(208
                , "Already Reported"
                , "【WebDAV; RFC 5842】<code>propstat</code> 响应元素中声明的成员，已经在[（多状态）响应之前的部分]被列举。用于避免[重复枚举多个绑定的内部成员到同一个集合]。"
                , HttpStatus.ALREADY_REPORTED
                , HttpStatus.Series.valueOf(HttpStatus.ALREADY_REPORTED).name())
        , IM_USED(226
                , "IM Used"
        ...
        , MULTIPLE_CHOICES(300
                ...
                , HttpStatus.Series.valueOf(HttpStatus.MULTIPLE_CHOICES).name())
        , MOVED_PERMANENTLY(301
                ...
                , HttpStatus.Series.valueOf(HttpStatus.MOVED_PERMANENTLY).name())
        , FOUND(302
                , "Found"
                ...
                , HttpStatus.FOUND
                , HttpStatus.Series.valueOf(HttpStatus.FOUND).name())
        , SEE_OTHER(303
                , "See Other"
                ...
                , HttpStatus.Series.valueOf(HttpStatus.SEE_OTHER).name())
        , NOT_MODIFIED(304
                , "Not Modified"
                ...
                , HttpStatus.Series.valueOf(HttpStatus.NOT_MODIFIED).name())
        , @Deprecated USE_PROXY(305
                ...
                , HttpStatus.Series.valueOf(HttpStatus.USE_PROXY).name())
        , @Deprecated SWITCH_PROXY(306
                , "Switch Proxy"
        ...
        , TEMPORARY_REDIRECT(307
                ...
                , HttpStatus.Series.valueOf(HttpStatus.TEMPORARY_REDIRECT).name())
        ...
        , BAD_REQUEST(400
                ...
                , HttpStatus.Series.valueOf(HttpStatus.BAD_REQUEST).name())
        , UNAUTHORIZED(401
                , "Unauthorized"
                ...
                , HttpStatus.Series.valueOf(HttpStatus.UNAUTHORIZED).name())
        , PAYMENT_REQUIRED(402
                ...
                , HttpStatus.Series.valueOf(HttpStatus.PAYMENT_REQUIRED).name())
        , FORBIDDEN(403
                , "Forbidden"
                , "服务器已经理解请求，但是拒绝执行它。"
                ...
                , HttpStatus.Series.valueOf(HttpStatus.FORBIDDEN).name())
        , NOT_FOUND(404
                , "Not Found"
                ...
                , HttpStatus.Series.valueOf(HttpStatus.NOT_FOUND).name())
        , METHOD_NOT_ALLOWED(405
                ...
                , HttpStatus.Series.valueOf(HttpStatus.METHOD_NOT_ALLOWED).name())
        , NOT_ACCEPTABLE(406
                , "Not Acceptable"
                ...
                , HttpStatus.Series.valueOf(HttpStatus.NOT_ACCEPTABLE).name())
        , PROXY_AUTHENTICATION_REQUIRED(407
                ...
                , HttpStatus.Series.valueOf(HttpStatus.PROXY_AUTHENTICATION_REQUIRED).name())
        , REQUEST_TIMEOUT(408
                , "Request Timeout"
                , "请求超时。"
                ...
                , HttpStatus.Series.valueOf(HttpStatus.REQUEST_TIMEOUT).name())
        , CONFLICT(409
                , "Conflict"
                , "表示因为请求存在冲突而无法处理该请求"
                ...
                , HttpStatus.CONFLICT
                , HttpStatus.Series.valueOf(HttpStatus.CONFLICT).name())
        , GONE(410
                , "Gone"
                ...
                , HttpStatus.GONE
                , HttpStatus.Series.valueOf(HttpStatus.GONE).name())
        , LENGTH_REQUIRED(411
                , "Length Required"
                , "服务器拒绝在没有定义 Content-Length 头的情况下接受请求。"
                    .concat("\n在添加了表明请求消息体长度的有效 Content-Length 头之后，客户端可以再次提交该请求。")
                , HttpStatus.LENGTH_REQUIRED
                , HttpStatus.Series.valueOf(HttpStatus.LENGTH_REQUIRED).name())
        , PRECONDITION_FAILED(412
                ...
                , HttpStatus.Series.valueOf(HttpStatus.PRECONDITION_FAILED).name())
        , PAYLOAD_TOO_LARGE(413
                ...
                , HttpStatus.Series.valueOf(HttpStatus.PAYLOAD_TOO_LARGE).name())
        , URI_TOO_LONG(414
                , "URI Too Long"
                ...
                , HttpStatus.Series.valueOf(HttpStatus.URI_TOO_LONG).name())
        , UNSUPPORTED_MEDIA_TYPE(415
                , "Unsupported Media Type"
                , "对于当前请求的方法和所请求的资源，请求中提交的互联网媒体类型不是服务器所支持的格式，因此请求被拒绝。"
                    .concat("\n例如，客户端将图像上传格式为 svg，但服务器要求图像使用上传格式为 jpg。")
                , HttpStatus.UNSUPPORTED_MEDIA_TYPE
                , HttpStatus.Series.valueOf(HttpStatus.UNSUPPORTED_MEDIA_TYPE).name())
        , REQUESTED_RANGE_NOT_SATISFIABLE(416
                ...
                , HttpStatus.Series.valueOf(HttpStatus.REQUESTED_RANGE_NOT_SATISFIABLE).name())
        , EXPECTATION_FAILED(417
                , "Expectation Failed"
                , "服务器无法满足 <code>Expect</code> 请求标头字段指示的期望值。"
                , HttpStatus.EXPECTATION_FAILED
                , HttpStatus.Series.valueOf(HttpStatus.EXPECTATION_FAILED).name())
        , I_AM_A_TEAPOT(418
                , "I'm a teapot"
                ...
                , HttpStatus.Series.valueOf(HttpStatus.I_AM_A_TEAPOT).name())
        ...
        , UNPROCESSABLE_ENTITY(422
                ...
                , HttpStatus.Series.valueOf(HttpStatus.UNPROCESSABLE_ENTITY).name())
        , LOCKED(423
                , "Locked"
                , "【WebDAV; RFC 4918】当前资源被锁定。"
                , HttpStatus.LOCKED
                , HttpStatus.Series.valueOf(HttpStatus.LOCKED).name())
        , FAILED_DEPENDENCY(424
                , "Failed Dependency"
                , "【WebDAV; RFC 4918】由于之前的某个请求的失败，导致当前请求失败。"
                    .concat("\n例如 PROPPATCH。")
                , HttpStatus.FAILED_DEPENDENCY
                , HttpStatus.Series.valueOf(HttpStatus.FAILED_DEPENDENCY).name())
        , TOO_EARLY(425
                , "Too Early"
                , "【RFC 8470】服务器不愿意冒着风险去处理可能重播的请求。（服务器拒绝处理在Early Data中的请求，以规避可能的重放攻击。）"
                , HttpStatus.TOO_EARLY
                , HttpStatus.Series.valueOf(HttpStatus.TOO_EARLY).name())
        , UPGRADE_REQUIRED(426
                ...
                , HttpStatus.Series.valueOf(HttpStatus.UPGRADE_REQUIRED).name())
        , PRECONDITION_REQUIRED(428
                , "Precondition Required"
                , "【RFC 6585】原始服务器要求[当前请求]是[有条件的]。"
                    .concat("\n该状态码旨在防止“丢失更新”的问题，即[客户端获取资源状态后，修改该状态并将其提交给服务器，但这期间第三方已经修改了服务器上的状态，从而导致冲突]。")
                , HttpStatus.PRECONDITION_REQUIRED
                , HttpStatus.Series.valueOf(HttpStatus.PRECONDITION_REQUIRED).name())
        , TOO_MANY_REQUESTS(429
                ...
                , HttpStatus.Series.valueOf(HttpStatus.TOO_MANY_REQUESTS).name())
        , REQUEST_HEADER_FIELDS_TOO_LARGE(431
                , "Request Header Fields Too Large"
                , "【RFC 6585】服务器不愿意处理该请求，因为它的请求头字段太大。"
                    .concat("\n请求可以在减小请求头字段的大小后重新提交。")
                , HttpStatus.REQUEST_HEADER_FIELDS_TOO_LARGE
                , HttpStatus.Series.valueOf(HttpStatus.REQUEST_HEADER_FIELDS_TOO_LARGE).name())
        ...
        , INTERNAL_SERVER_ERROR(500
                ...
                , HttpStatus.Series.valueOf(HttpStatus.INTERNAL_SERVER_ERROR).name())
        , NOT_IMPLEMENTED(501
                , "Not Implemented"
                , "此请求方法不被服务器支持且无法被处理。"
                    .concat("\n例如，网络服务 API 的新功能")
                ...
                , HttpStatus.Series.valueOf(HttpStatus.NOT_IMPLEMENTED).name())
        , BAD_GATEWAY(502
                , "Bad Gateway"
                , "此错误响应表明服务器作为网关需要得到一个处理这个请求的响应，但是得到的却是一个错误的响应。"
                    .concat("\n作为网关或者代理工作的服务器尝试执行请求时，从上游服务器接收到无效的响应。")
                , HttpStatus.BAD_GATEWAY
                , HttpStatus.Series.valueOf(HttpStatus.BAD_GATEWAY).name())
        ...
        , GATEWAY_TIMEOUT(504
                ...
                , HttpStatus.Series.valueOf(HttpStatus.GATEWAY_TIMEOUT).name())
        , HTTP_VERSION_NOT_SUPPORTED(505
                , "HTTP Version not supported"
                , "服务器不支持，或者拒绝支持请求中所使用的 HTTP 版本。"
                    .concat("\n响应中应当包含一个[说明版本不被支持的原因]以及[服务器支持哪些协议]的实体。")
                , HttpStatus.HTTP_VERSION_NOT_SUPPORTED
                , HttpStatus.Series.valueOf(HttpStatus.HTTP_VERSION_NOT_SUPPORTED).name())
        , VARIANT_ALSO_NEGOTIATES(506
                ...
                , HttpStatus.Series.valueOf(HttpStatus.VARIANT_ALSO_NEGOTIATES).name())
        , INSUFFICIENT_STORAGE(507
                , "Insufficient Storage"
                , "【WebDAV; RFC 4918】服务器无法存储完成请求所必须的内容。"
                    .concat("这个状况被认为是临时的。")
                , HttpStatus.INSUFFICIENT_STORAGE
                , HttpStatus.Series.valueOf(HttpStatus.INSUFFICIENT_STORAGE).name())
        , LOOP_DETECTED(508
                , "Loop Detected"
                , "【WebDAV; RFC 5842】服务器在处理请求时检测到无限循环。（可代替 <code>208</code> 状态码）"
                , HttpStatus.LOOP_DETECTED
                , HttpStatus.Series.valueOf(HttpStatus.LOOP_DETECTED).name())
        , NOT_EXTENDED(510
                , "Not Extended"
                , "【RFC 2774】获取资源所需要的策略并没有被满足 —— 客户端需要对请求进一步扩展，服务器才能实现它。"
                    .concat("\n服务器会回复客户端发出扩展请求所需的所有信息。")
                , HttpStatus.NOT_EXTENDED
                , HttpStatus.Series.valueOf(HttpStatus.NOT_EXTENDED).name())
