...
public final class EntityUtil {
    ...
    public static final class Regex {
        ...
        public static final class GeneralRule {
             ...
             * 正整数
             *
             * @Description 正整数的简单校验.
             *
             * @param param 被校验对象, 不为 {@literal null}.
             *
             * @return 校验结果
             */
            public /*static*/ boolean positiveInteger(@NotNull String param)
                    throws IllegalArgumentException
            {
                //=== 参数合法性校验 ===//
             ...
             * 中文, 英文单词, 数字
             *
             * @Description 中文、英文单词与数字的集合的简单校验; 交集/并集 取决于参数 {@param param}.
             *
             * @param param 被校验对象, 不为 null, 非空字符串.
             * @param rule  参数集合; 说明:
             *              {
             ...
             *
             * @Reference
             * {@link <a href="https://stackoverflow.com/questions/3809401/what-is-a-good-regular-expression-to-match-a-url">javascript - What is a good regular expression to match a URL? - Stack Overflow</a>}
             * {@link <a href="https://blog.walterlv.com/post/match-web-url-using-regex.html">使用正则表达式尽可能准确匹配域名/网址</a>}
             * {@linkplain <a href="https://www.cnblogs.com/panpanwelcome/p/7464511.html">正则匹配-URL-域名 - 晴天彩虹 - 博客园</a> (相关知识)}
             *
             * @param param 被校验对象
             *
             * @return 校验结果
