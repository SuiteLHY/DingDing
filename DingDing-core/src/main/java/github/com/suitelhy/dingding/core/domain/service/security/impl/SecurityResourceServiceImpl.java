...
//     * 查询 (关联的) 角色
//     *
//     * @param code  角色编码    {@link SecurityResource#getCode()}
//     *
...
//     */
//    @Override
//    public @Nullable List<Map<String, Object>> selectRoleByCode(@NotNull String code) {
//        if (! SecurityResource.Validator.RESOURCE.code(code)) {
//            //-- 非法输入: 角色编码
//            throw new IllegalArgumentException(String.format("非法参数:<param>%s</param>->【%s】 <= 【<class>%s</class>-<method>%s</method> <- 第%s行】"
//                    , "角色编码"
...
//     */
//    @Override
//    public @NotNull List<Map<String, Object>> selectUrlByCode(@NotNull String code) {
//        if (!SecurityResource.Validator.RESOURCE.code(code)) {
//            //-- 非法输入: 资源编码
//            throw new IllegalArgumentException(String.format("非法参数:<param>%s</param>->【%s】 <= 【<class>%s</class>-<method>%s</method> <- 第%s行】"
//                    , "资源编码"
...
//        }
//
//        final @NotNull List<Map<String, Object>> result = new ArrayList<>(1);
//
//        final List<SecurityResourceUrl> dataSet = resourceUrlService.selectByResourceCode(code);
...
//                }
//
//                final Map<String, Object> eachMap = new HashMap<>(3);
//                eachMap.put("clientId", each.getClientId());
//                eachMap.put("urlPath", each.getUrlPath());
//                eachMap.put("urlMethod", each.getUrlMethod());
//
//                result.add(eachMap);
//            }
//        }
...
//    }
            ...
            throws IllegalArgumentException, BusinessAtomicException
    {
        ...
        final SecurityResource new_resource = SecurityResource.Factory.RESOURCE.update(latest_resource.getId()
                , old_resource.getCode()
                , old_resource.getIcon()
                , old_resource.getLink()
                , old_resource.getName()
        ...
        //=== 操作日志记录 ===//
        final Log newLog_SecurityRole = Log.Factory.SecurityResource.LOG.create(null
                , null
                , HandleType.LogVo.SECURITY__SECURITY_RESOURCE__UPDATE
                , old_resource
                , operator
...
//     */
//    @Override
//    public boolean deleteRole(@NotNull Set<SecurityResource> resources, @NotNull Set<SecurityRole> roles, @NotNull SecurityUser operator)
//            throws BusinessAtomicException
//    {
//        if (null == resources || resources.isEmpty()) {
//            //-- 非法输入: [（安全认证）资源]
...
//
//                    if (! securityRoleResourceService.delete(eachRole, each, operator)) {
//                        //-- 操作失败: 删除 角色 - 资源 关联
//                        throw new BusinessAtomicException(String.format("操作失败:<param>%s</param>->【%s】&【%s】&【%s】 <= 【<class>%s</class>-<method>%s</method> <- 第%s行】"
...
//     *
//     * @param resources                         [（安全认证）资源], 必须全部合法且已持久化 {@link SecurityResource}
//     * @param urlInfoSet                        [URL 信息]                           {@link SecurityResourceUrl}
//     * @param operator                          操作者
//     * @param operator_userAccountOperationInfo [操作者 - 账户操作基础记录]
//     *
//     * @return 操作是否成功
//     */
//    @Override
//    public boolean deleteUrl(@NotNull Set<SecurityResource> resources
//            , @NotNull ContainArrayHashSet<String> urlInfoSet
//            , @NotNull SecurityUser operator
//            , @NotNull UserAccountOperationInfo operator_userAccountOperationInfo)
//            throws IllegalArgumentException, BusinessAtomicException
...
//
//                    final @NotNull SecurityResourceUrl resourceUrl = SecurityResourceUrl.Factory.RESOURCE_URL.create(
//                            each.getCode()
//                            , urlInfo[0]
//                            , urlInfo[1]
//                            , urlInfo[2]);
//                    if (! resourceUrlService.delete(resourceUrl, operator, operator_userAccountOperationInfo)) {
//                        //-- 操作失败: 删除[资源 - URL]关联
//                        throw new BusinessAtomicException(String.format("操作失败:<param>%s</param>->【%s】&【%s】 <= 【<class>%s</class>-<method>%s</method> <- 第%s行】"
