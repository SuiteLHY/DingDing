package github.com.suitelhy.dingding.userservice.infrastructure.domain.sql.provider;
//
//import User;
...
//        }
//        Map<String, String> columnsMap = user.MAPPER.getColumnsMapForSQL(user, "user.");
