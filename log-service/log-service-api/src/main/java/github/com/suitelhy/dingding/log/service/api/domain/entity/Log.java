package github.com.suitelhy.dingding.log.service.api.domain.entity;
...
public class Log
    ...
    /**
     * 转换为 [JSON格式的字符串] <- Entity 对象
     *
     * @Description 一般用于在安全渠道中的数据输出.
     *
     * @return 转换结果
     */
    @Override
    public @NotNull String toJSONString() {
        if (! isEmpty()) {
            return String.format("{\"_class_name\":\"%s\", \"id\":\"%s\", \"description\":\"%s\", \"detail\":\"%s\", \"time\":\"%s\", \"type\":\"%s\", \"operatorIp\":\"%s\", \"operatorUsername\":\"%s\", \"targetId\":\"%s\"}"
                    ...
                    , this.getDescription()
                    , (null != this.getDetail()) ? this.getDetail() : ""
                    , this.getTime()
                    , this.getType()
                    , this.getOperatorIp()
                    , this.getOperatorUsername()
                    , this.getTargetId());
        }
    ...
    public enum Validator
        ...
        public boolean operatorIp(@NotNull String ip) {
            return NetUtil.getInstance().validateIpAddress(ip) && ip.length() < 33;
        }
     ...
     * (Constructor)
     *
     * @param id                {@linkplain this#id [日志记录 - 编号]}
     * @param description       {@linkplain this#description 操作的描述信息}
     * @param detail            {@linkplain this#detail 操作的详细信息}
     * @param time              {@linkplain this#time 操作时间}
     * @param type              {@linkplain this#type 操作类型}
     * @param operatorIp        {@linkplain this#operatorIp [操作者 - （执行操作时）登录的 IP 地址]}
     * @param operatorUsername  {@linkplain this#operatorUsername [操作者 - 用户名称]}
     * @param targetId          {@linkplain this#targetId [被操作对象 - 用于日志追踪的 ID]}
     * @param validator         {@linkplain Validator 实体验证器}
     *
    ...
    public interface Factory {
        ...
        enum SecurityResource
             ...
             * @param time                              操作时间
             * @param type                              {@linkplain HandleType.LogVo 操作类型}
             * @param resource                          {@linkplain github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityResource [（安全认证）资源]}
             * @param operator                          {@linkplain github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser 操作者}
             * @param operator_UserAccountOperationInfo {@linkplain github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo [操作者 - 账户操作基础记录]}
             *
             * @return {@link Log}
             */
            public @NotNull Log create(@Nullable String description
                    , @Nullable String detail
                    , @NotNull String time
                    , @NotNull HandleType.LogVo type
                    , @NotNull github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityResource resource
                    , @NotNull github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser operator
                    , @NotNull github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo operator_UserAccountOperationInfo)
                    throws IllegalArgumentException
            {
             ...
             */
            @Override
            public @NotNull Log createDefault() {
                return new Log();
            }
        ...
        enum SecurityResourceUrl
             ...
             * @param time                              操作时间
             * @param type                              {@linkplain HandleType.LogVo 操作类型}
             * @param resourceUrl                       {@linkplain github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityResourceUrl [资源 ←→ URL]}
             * @param operator                          {@linkplain github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser 操作者}
             * @param operator_UserAccountOperationInfo {@linkplain github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo [操作者 - 账户操作基础记录]}
             *
             * @return {@link Log}
            ...
            public @NotNull Log create(@Nullable String description
                    ...
                    , @NotNull String time
                    , @NotNull HandleType.LogVo type
                    , @NotNull github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityResourceUrl resourceUrl
                    , @NotNull github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser operator
                    , @NotNull github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo operator_UserAccountOperationInfo)
                    throws IllegalArgumentException
            {
        ...
        enum SecurityRole
             ...
             * @param time                              操作时间
             * @param type                              {@linkplain HandleType.LogVo 操作类型}
             * @param role                              {@linkplain github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityRole [（安全认证）角色]}
             * @param operator                          {@linkplain github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser 操作者}
             * @param operator_UserAccountOperationInfo {@linkplain github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo [操作者 - 账户操作基础记录]}
             *
             * @return {@link Log}
            ...
            public @NotNull Log create(@Nullable String description
                    ...
                    , @NotNull String time
                    , @NotNull HandleType.LogVo type
                    , @NotNull github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityRole role
                    , @NotNull github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser operator
                    , @NotNull github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo operator_UserAccountOperationInfo)
                    throws IllegalArgumentException
            {
        ...
        enum SecurityRoleResource
             ...
             * @param time                              操作时间
             * @param type                              {@linkplain HandleType.LogVo 操作类型}
             * @param roleResource                      {@linkplain github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityRoleResource [角色 ←→ 资源]}
             * @param operator                          {@linkplain github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser 操作者}
             * @param operator_UserAccountOperationInfo {@linkplain github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo [操作者 - 账户操作基础记录]}
             *
             * @return {@link Log}
            ...
            public @NotNull Log create(@Nullable String description
                    ...
                    , @NotNull String time
                    , @NotNull HandleType.LogVo type
                    , @NotNull github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityRoleResource roleResource
                    , @NotNull github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser operator
                    , @NotNull github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo operator_UserAccountOperationInfo)
                    throws IllegalArgumentException
            {
        ...
        enum SecurityUser
             ...
             * @param time                              操作时间
             * @param type                              {@linkplain HandleType.LogVo 操作类型}
             * @param user                              {@linkplain github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser [（安全认证）用户]}
             * @param operator                          {@linkplain github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser 操作者}
             * @param operator_UserAccountOperationInfo {@linkplain github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo [操作者 - 账户操作基础记录]}
             *
             * @return {@link Log}
            ...
            public @NotNull Log create(@Nullable String description
                    ...
                    , @NotNull String time
                    , @NotNull HandleType.LogVo type
                    , @NotNull github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser user
                    , @NotNull github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser operator
                    , @NotNull github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo operator_UserAccountOperationInfo)
                    throws IllegalArgumentException
            {
             ...
             * @param detail                            操作的详细信息
             * @param type                              {@linkplain HandleType.LogVo 操作类型}
             * @param user                              （安全认证）用户              {@link github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser}
             * @param operator                          {@linkplain github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser 操作者}
             * @param operator_UserAccountOperationInfo {@linkplain github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo [操作者 - 账户操作基础记录]}
             *
             * @return {@link Log}
        ...
        enum SecurityUserRole
             ...
             * @param time                              操作时间
             * @param type                              {@linkplain HandleType.LogVo 操作类型}
             * @param userRole                          [（安全认证）用户 ←→ 角色]     {@link github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUserRole}
             * @param operator                          {@linkplain github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser 操作者}
             * @param operator_UserAccountOperationInfo {@linkplain github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo [操作者 - 账户操作基础记录]}
             *
             * @return {@link Log}
            ...
            public @NotNull Log create(@Nullable String description
                    ...
                    , @NotNull String time
                    , @NotNull HandleType.LogVo type
                    , @NotNull github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUserRole userRole
                    , @NotNull github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser operator
                    , @NotNull github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo operator_UserAccountOperationInfo)
                    throws IllegalArgumentException
            {
        ...
        enum User
             ...
             * @param time                              操作时间
             * @param type                              {@linkplain HandleType.LogVo 操作类型}
             * @param user                              用户基础信息                 {@link github.com.suitelhy.dingding.security.service.api.domain.entity.User}
             * @param operator                          {@linkplain github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser 操作者}
             * @param operator_UserAccountOperationInfo {@linkplain github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo [操作者 - 账户操作基础记录]}
             *
             * @return {@link Log}
            ...
            public @NotNull Log create(@Nullable String description
                    ...
                    , @NotNull String time
                    , @NotNull HandleType.LogVo type
                    , @NotNull github.com.suitelhy.dingding.security.service.api.domain.entity.User user
                    , @NotNull github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser operator
                    , @NotNull github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo operator_UserAccountOperationInfo)
                    throws IllegalArgumentException
            {
             ...
             * @param detail                            操作的详细信息
             * @param type                              {@linkplain HandleType.LogVo 操作类型}
             * @param user                              {@linkplain github.com.suitelhy.dingding.security.service.api.domain.entity.User 用户基础信息}
             * @param operator                          {@linkplain github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser 操作者}
             * @param operator_UserAccountOperationInfo {@linkplain github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo [操作者 - 账户操作基础记录]}
             *
             * @return {@link Log}
        ...
        enum UserAccountOperationInfo
             ...
             * @param time                              操作时间
             * @param type                              {@linkplain HandleType.LogVo 操作类型}
             * @param operationInfo                     {@linkplain github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo [用户 -> 账户操作基础记录]}
             * @param operator                          {@linkplain github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser 操作者}
             * @param operator_UserAccountOperationInfo {@linkplain github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo [操作者 - 账户操作基础记录]}
             *
             * @return {@link Log}
            ...
            public @NotNull Log create(@Nullable String description
                    ...
                    , @NotNull String time
                    , @NotNull HandleType.LogVo type
                    , @NotNull github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo operationInfo
                    , @NotNull github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser operator
                    , @NotNull github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo operator_UserAccountOperationInfo)
                    throws IllegalArgumentException
            {
        ...
        enum UserPersonInfo
             ...
             * @param time                              操作时间
             * @param type                              {@linkplain HandleType.LogVo 操作类型}
             * @param userPersonInfo                    {@linkplain github.com.suitelhy.dingding.user.service.api.domain.entity.UserPersonInfo [用户 -> 个人信息]}
             * @param operator                          {@linkplain github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser 操作者}
             * @param operator_UserAccountOperationInfo {@linkplain github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo [操作者 - 账户操作基础记录]}
             *
             * @return {@link Log}
            ...
            public @NotNull Log create(@Nullable String description
                    ...
                    , @NotNull String time
                    , @NotNull HandleType.LogVo type
                    , @NotNull github.com.suitelhy.dingding.user.service.api.domain.entity.UserPersonInfo userPersonInfo
                    , @NotNull github.com.suitelhy.dingding.security.service.api.domain.entity.security.SecurityUser operator
                    , @NotNull github.com.suitelhy.dingding.user.service.api.domain.entity.UserAccountOperationInfo operator_UserAccountOperationInfo)
                    throws IllegalArgumentException
            {
