...
@EnableJpaRepositories(basePackages = {"github.com.suitelhy.dingding.core.domain.repository"}
...
public class PrimaryDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("github.com.suitelhy.dingding.core.domain.entity") // 设置实体类所在位置
