...
public class LogTaskTests {
    ...
    private Log getEntityForTest(@NotNull /*User*/AbstractSecurityUser securityUser, @NotNull /*SecurityUser*/SecurityUserTestClass operator, @NotNull HandleType.LogVo logVo)
        ...
        final @NotNull SecurityUser securityOperator = userEvent.selectSecurityUserByUsername(operator.getUsername());

        final UserAccountOperationInfo operator_OperationInfo = userEvent.selectUserAccountOperationInfoByUsername(operator.getUsername());
