...
public class ResourceTaskTests {
     ...
     * @return {@link RoleDto}
     */
    private @NotNull RoleDto getRoleForTest() {
     ...
     * @return {@link RoleDto}
     */
    private @NotNull RoleDto getRoleForTest(@Nullable Integer seed) {
     ...
     */
    private @NotNull ResourceDto getResourceForTest() {
     ...
     * @return {@link RoleDto}
     */
    private @NotNull ResourceDto getResourceForTest(@Nullable Integer seed) {
        long current_Millisecond = new CalendarController().getTimeInMillis();
     ...
     */
    private @NotNull AbstractSecurityUser getSecurityUserForTest() {
    ...
    private @NotNull UserDto getUserInfo(@NotNull AbstractSecurityUser securityUser)
            throws IllegalAccessException
    {
    ...
    public void selectAllResource__operator() {
        final @NotNull TaskResult<Page<ResourceDto>> result;
...
//    }
    ...
    public void selectResourceByRoleCode() {
        ...
        Assert.isTrue((result = resourceTask.selectResourceByRoleCode("USER", operator_OAuth2_UserDetails)).isSuccess()
    ...
    public void selectResourceByUsername() {
        ...
        Assert.isTrue((result = resourceTask.selectResourceByUsername("admin", operator_OAuth2_UserDetails)).isSuccess()
