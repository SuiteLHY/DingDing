 ...
 * @Problem 1. JDK 8 提供的 enum 类型, 目前在任何情况下不允许被(enum 类型)继承. 所以很多通用设计且可模块化复用的代码只能在实现类中重复实现.(orz)
 ...
 *
 */
package github.com.suitelhy.dingding.sso.authorization.infrastructure.domain.vo;