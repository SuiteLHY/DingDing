...
public class ResourceDto
     ...
     * [唯一标识 <- DTO 对象]
     */
    private final transient @NotNull SecurityResource dtoId;
            ...
            throws IllegalArgumentException
    {
        ...
        if (null == resourceUrls) {
            ...
            for (final @NotNull SecurityResourceUrl eachResourceUrl : resourceUrls) {
    ...
    public @NotNull String toJSONString() {
        ...
        return String.format("{\"_class_name\":\"%s\", \"code\":\"%s\", \"name\":\"%s\", \"type\":%s}"
                , getClass().getSimpleName()
                , (null != this.code) ? this.code : ""
                , (null != this.name) ? this.name : ""
                , (null != this.type) ? this.type : "");
    ...
    public enum Factory
         ...
         */
        public @NotNull ResourceDto create(@NotNull SecurityResource resource) {
         ...
         * @return {@link ResourceDto}
         */
        public @NotNull ResourceDto create(@NotNull SecurityResource resource, @NotNull HashSet<Map<String, Object>> urlInfoSet) {
            ...
            for (@NotNull Map<String, Object> eachUrlInfo : urlInfoSet) {
         ...
         * @return {@link ResourceDto}
         */
        public @NotNull ResourceDto create(@NotNull String code
                , String icon
                , String link
                , @NotNull String name
         ...
         */
        public @NotNull ResourceDto update(@NotNull Long id
                , @NotNull String code
                , String icon
                , String link
                , @NotNull String name
         ...
         */
        @Override
        public @NotNull ResourceDto createDefault() {
