//package github.com.suitelhy.dingding.sso.authorization.infrastructure.config.nacos;
//
...
// * Nacos 服务实例 -> 上下线控制器
// *
// * @Description 解决 {@linkplain <a href="https://github.com/alibaba/spring-cloud-alibaba/issues/1805">springCloudAlibaba+dubbo+nacos环境下，重启服务提供者或先启动服务消费者后启动服务提供者的情况下，消费者有时候会出现找不到服务的问题及解决方案（In the spring cloud Alibaba + Dubbo + Nacos environment, when the service provider is restarted or the service consumer is started first and then the service provider, sometimes the consumer can not find the service when calling） · Issue #1805 · alibaba/spring-cloud-alibaba</a> SpringCloudAlibaba + Dubbo + Nacos 的部分版本环境下，消费者有时候会出现找不到生产者服务的问题及解决方案}
// */
//@Component
//@Slf4j
...
//                ThreadUtils.shutdownThreadPool(NacosServiceInstanceUpAndDownOperator.this.executorService, log);
//            }
//        }
//
//    }
