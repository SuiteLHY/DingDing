...
import github.com.suitelhy.dingding.sso.authorization.application.task.impl.RoleTaskImpl;
...
public interface RoleTask {
     ...
     */
    @NotNull TaskResult<Page<RoleDto>> selectAllRole(int pageIndex, int pageSize, @NotNull AbstractSecurityUser operator);
     ...
     * @param pageIndex 分页索引, 从0开始
     * @param pageSize  分页 - 每页容量
     * @param operator  {@linkplain OAuth2AuthenticationInfo.AbstractUserAuthentication.AbstractDetails 操作者}
     *
     * @return {@link TaskResult}
     */
    @NotNull TaskResult<Page<RoleDto>> selectAllRole(int pageIndex, int pageSize, OAuth2AuthenticationInfo.AbstractUserAuthentication.@NotNull AbstractDetails operator);
     ...
     * @return {@link TaskResult}
     */
    @NotNull TaskResult<Page<RoleDto>> selectRoleByUsername(@NotNull String username, int pageIndex, int pageSize
