...
public class RoleDto
    ...
    private final transient @NotNull SecurityRole dtoId;
    ...
    public @NotNull String toJSONString() {
        ...
        return String.format("{\"_class_name\":\"%s\", \"code\":\"%s\", \"name\":\"%s\", \"description\":\"%s\"}"
                , getClass().getSimpleName()
                , (null != this.code) ? this.code : ""
                , (null != this.name) ? this.name : ""
                , (null != this.description) ? this.description : "");
    ...
    public enum Factory
         ...
         * @return {@link RoleDto}
         */
        public @NotNull RoleDto create(SecurityRole role) {
         ...
         * @return {@link RoleDto}
         */
        public @NotNull RoleDto create(@NotNull String code
                , @NotNull String name
         ...
         * @return {@link RoleDto}
         */
        public @NotNull RoleDto create(@NotNull Security.RoleVo roleVo) {
         ...
         */
        public @NotNull RoleDto update(@NotNull Long id
                , @NotNull String code
                , @NotNull String name
                , @Nullable String description)
                throws IllegalArgumentException
         ...
         */
        @Override
        public @NotNull RoleDto createDefault() {
            return new RoleDto();
        }
