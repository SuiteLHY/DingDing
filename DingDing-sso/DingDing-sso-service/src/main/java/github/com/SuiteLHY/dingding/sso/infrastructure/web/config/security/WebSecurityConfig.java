package github.com.suitelhy.dingding.sso.infrastructure.web.config.security;

import github.com.suitelhy.dingding.sso.web.security.WebchatAuthenticationFailureHandler;
import github.com.suitelhy.dingding.sso.web.security.WebchatAuthenticationSuccessHandler;
...
//                    .defaultSuccessUrl("/user/login") // 登录成功之后, 默认跳转的页面
    ...
    private String[] getEndpointWithoutAuthentication() {
        return new String[]{
                ...
                , "/static/source/**/*.*"
                //=== Swagger UI ===//
                //-> {@Reference <a href="https://stackoverflow.com/questions/37671125/how-to-configure-spring-security-to-allow-swagger-url-to-be-accessed-without-aut">
                //->        如何配置Spring Security以允许无需身份验证即可访问Swagger URL-代码日志</a>}
                , "/v2/api-docs"
                , "/swagger-ui.html"
                , "/swagger-resources/**"
                , "/configuration/ui"
