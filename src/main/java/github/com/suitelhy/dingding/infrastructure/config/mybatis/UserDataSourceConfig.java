//package github.com.suitelhy.dingding.infrastructure.config.datasource;
//
...
///*@MapperScan(basePackages = "github.com.suitelhy.dingding.domain.repository"
...
//    // 注入配置文件属性
//    @ConfigurationProperties(prefix = "dingding.datasource.user")
