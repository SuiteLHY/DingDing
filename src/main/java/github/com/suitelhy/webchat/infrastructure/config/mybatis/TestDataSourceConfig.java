...
//    // 注入配置文件属性
//    @ConfigurationProperties(prefix = "webchat.datasource.test")
...
//        // Mybatis - 自定义配置实现注入
//        factoryBean.setTypeHandlersPackage("github.com.suitelhy.webchat.infrastructure.config.mybatis.typehandler");
