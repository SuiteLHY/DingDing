...
//    private String clientId;
    ...
    private SecurityUser getEntityForTest() {
        return SecurityUser.Factory.USER.create("402880e56fb72000016fb72014fc0000"
                , "测试20200118132850"
                , VoUtil.getInstance().getVoByValue(Account.StatusVo.class, 1));
    }
            ...
            throws BusinessAtomicException
    {
        ...
        Assert.isTrue(securityRoleEvent.insertUserRoleRelationship(newEntity, newRole, operator())
            ...
            throws Exception
    {
        ...
        Assert.isTrue(securityRoleEvent.insertRoleResourceRelationship(newRole, newResource, operator())
