...
//    private String clientId;
    ...
    /**
     * @see SecurityUrlReadEvent#existResourceOnUrlInfo(String[])
     */
    @Test
    @Transactional
...
//        final @NotNull UserAccountOperationInfo operator_userAccountOperationInfo = userReadEvent.selectUserAccountOperationInfoByUsername(operator().getUsername());
    ...
    /**
     * @see SecurityUrlReadEvent#selectResourceUrlRelationshipOnUrlInfoByClientIdAndUrlPath(String, String)
     */
    @Test
    @Transactional
...
//        final @NotNull UserAccountOperationInfo operator_userAccountOperationInfo = userReadEvent.selectUserAccountOperationInfoByUsername(operator.getUsername());
    ...
    /**
     * @see SecurityUrlNonIdempotentEvent#insertUrlInfo(SecurityResource, String[], SecurityUser)
     */
    @Test
    @Transactional
...
//        final @NotNull UserAccountOperationInfo operator_userAccountOperationInfo = userReadEvent.selectUserAccountOperationInfoByUsername(operator.getUsername());
    ...
    /**
     * @see SecurityUrlNonIdempotentEvent#deleteUrlInfo(String[], SecurityUser)
     */
    @Test
    @Transactional
