package github.com.suitelhy.dingding.security.service.provider.domain.repository.security;//package github.com.suitelhy.dingding.sso.authorization.domain.repository.security;
...
//    private String clientId;
    ...
    @Test
    @Transactional
    public void findSecurityResourceByCode() {
        //===== 添加测试数据
        SecurityResource newEntity = getEntityForTest();
        ...
        //===== findSecurityResourceByCode()
        Optional<SecurityResource> result = repository.findSecurityResourceByCode(newEntity.getCode());
