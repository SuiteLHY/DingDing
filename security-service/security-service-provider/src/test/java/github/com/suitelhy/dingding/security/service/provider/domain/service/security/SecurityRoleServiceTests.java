...
//        final @NotNull UserAccountOperationInfo operator_UserAccountOperationInfo = userReadEvent.selectUserAccountOperationInfoByUsername(operator.getUsername());
        ...
        // existsByCode(..)
        Assert.isTrue(securityRoleService.existsByCode(newEntity.getCode())
                , "The result -> false");
...
//        final @NotNull UserAccountOperationInfo operator_UserAccountOperationInfo = userReadEvent.selectUserAccountOperationInfoByUsername(operator.getUsername());
        ...
        // selectCount(..)
        Assert.isTrue((result = securityRoleService.selectCount(10)) > 0
...
//        final @NotNull UserAccountOperationInfo operator_UserAccountOperationInfo = userReadEvent.selectUserAccountOperationInfoByUsername(operator.getUsername());
        ...
        // selectRoleByCode(..)
        result = securityRoleService.selectRoleByCode(newEntity.getCode());
...
//        final @NotNull UserAccountOperationInfo operator_UserAccountOperationInfo = userReadEvent.selectUserAccountOperationInfoByUsername(operator.getUsername());
        ...
        Assert.isTrue(newEntity1.isEntityLegal()
                , "===== getEntityForTest() -> 无效的 Entity");
        Assert.isTrue(securityRoleService.insert(newEntity1, operator)
                , "===== 添加测试数据 -> false");
        ...
        Assert.isTrue(newEntity2.isEntityLegal()
                , "===== getEntityForTest() -> 无效的 Entity");
        Assert.isTrue(securityRoleService.insert(newEntity2, operator)
                , "===== 添加测试数据 -> false");
        ...
        Assert.isTrue(securityResourceService.insert(newResource, operator)
                , "===== 添加测试数据 -> false");
        Assert.isTrue(securityResourceService.insert(newResource1, operator)
                , "===== 添加测试数据 -> false");
        Assert.isTrue(securityResourceService.insert(newResource2, operator)
                , "===== 添加测试数据 -> false");
...
//        final @NotNull UserAccountOperationInfo operator_UserAccountOperationInfo = userReadEvent.selectUserAccountOperationInfoByUsername(operator.getUsername());
        ...
        Assert.isTrue(securityRoleService.update(result, operator)
                , "===== update(Entity) -> false");
...
//        final @NotNull UserAccountOperationInfo operator_UserAccountOperationInfo = userReadEvent.selectUserAccountOperationInfoByUsername(operator.getUsername());
        ...
        //=== delete(..)
        result = newEntity;
        Assert.isTrue(securityRoleService.delete(result, operator)
                , "===== delete(Entity) -> false");
