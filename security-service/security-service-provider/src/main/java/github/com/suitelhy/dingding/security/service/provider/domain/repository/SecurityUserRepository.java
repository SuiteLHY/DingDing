...
public interface SecurityUserRepository
     ...
     */
    @Override
    @NotNull Page<SecurityUser> findAll(Pageable pageable);
    ...
    @Transactional(isolation = Isolation.SERIALIZABLE
            , propagation = Propagation.REQUIRED)
    @NotNull Optional<SecurityUser> findByUsername(@NotNull String username);
    ...
    @Query(nativeQuery = true
            ...
            + "where ur.username = :username \n"
            + "group by code, name ")
    @NotNull List<Map<String, Object>> selectResourceByUsername(@NotNull @Param("username") String username);
    ...
    @Query(nativeQuery = true
            ...
            + "group by url_path ")
    @NotNull List<Map<String, Object>> selectURLByUsernameAndClientId(@NotNull @Param("username") String username
