...
public interface SecurityUserRoleRepository
     ...
     * @return {@link Page}
     */
    @NotNull Optional<SecurityUserRole> findByUsernameAndRoleCode(@NotNull String username, @NotNull String roleCode);
     ...
     * @return {@link Page}
     */
    @NotNull Page<SecurityUserRole> findAllByUsername(@NotNull String username, Pageable pageable);
    ...
    @Transactional(isolation = Isolation.SERIALIZABLE
            , propagation = Propagation.REQUIRED)
    @NotNull List<SecurityUserRole> findAllByUsername(@NotNull String username);
     ...
     * @return {@link Page}
     */
    @NotNull Page<SecurityUserRole> findAllByRoleCode(@NotNull String rodeCode, Pageable pageable);
    ...
    @Transactional(isolation = Isolation.SERIALIZABLE
            , propagation = Propagation.REQUIRED)
    @NotNull List<SecurityUserRole> findAllByRoleCode(@NotNull String rodeCode);
    ...
    @Transactional(isolation = Isolation.SERIALIZABLE
            , propagation = Propagation.REQUIRED)
    @NotNull List<Map<String, Object>> selectRoleByUsername(@NotNull @Param("username") String username);
