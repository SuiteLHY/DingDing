package github.com.suitelhy.dingding.security.service.provider.domain.repository;
...
public interface SecurityResourceUrlRepository
    ...
    @Transactional(isolation = Isolation.SERIALIZABLE
            , propagation = Propagation.REQUIRED)
    @NotNull List<SecurityResourceUrl> findAllByCode(@NotNull String resourceCode);
     ...
     * @return {@link Page}
     */
    @NotNull Page<SecurityResourceUrl> findAllByCode(@NotNull String resourceCode, Pageable pageable);
    ...
    @Transactional(isolation = Isolation.SERIALIZABLE
            , propagation = Propagation.REQUIRED)
    @NotNull List<SecurityResourceUrl> findAllByClientId(@NotNull String clientId);
    ...
    @Transactional(isolation = Isolation.SERIALIZABLE
            , propagation = Propagation.REQUIRED)
    @NotNull List<SecurityResourceUrl> findAllByClientIdAndUrlPath(@NotNull String clientId, @NotNull String urlPath);
     ...
     * @return {@link Page}
     */
    @NotNull Page<SecurityResourceUrl> findAllByClientIdAndUrlPath(@NotNull String clientId
    ...
    @Transactional(isolation = Isolation.SERIALIZABLE
            , propagation = Propagation.REQUIRED)
    @NotNull List<SecurityResourceUrl> findAllByClientIdAndUrlPathAndUrlMethod(@NotNull String clientId, @NotNull String urlPath, @NotNull String urlMethod);
     ...
     * @return {@link Page}
     */
    @NotNull Page<SecurityResourceUrl> findAllByClientIdAndUrlPathAndUrlMethod(@NotNull String clientId, @NotNull String urlPath, @NotNull String urlMethod
            , Pageable pageable);
     ...
     * @return {@link Page}
     */
    @NotNull Page<SecurityResourceUrl> findAllByCodeAndClientIdAndUrlPathAndUrlMethod(@NotNull String code, @NotNull String clientId, @NotNull String urlPath
