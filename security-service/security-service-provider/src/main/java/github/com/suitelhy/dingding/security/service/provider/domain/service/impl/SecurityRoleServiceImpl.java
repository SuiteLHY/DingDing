...
import github.com.suitelhy.dingding.security.service.provider.domain.repository.SecurityRoleRepository;
...
//    }
            ...
            throws IllegalArgumentException, BusinessAtomicException
    {
        ...
        final SecurityRole latest_role = repository.findByCode(old_role.getCode())
                .orElseGet(null);
        if (null == latest_role) {
