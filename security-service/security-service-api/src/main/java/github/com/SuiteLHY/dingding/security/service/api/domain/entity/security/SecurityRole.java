...
public class SecurityRole
    ...
    public static @Nullable Security.RoleVo changeIntoRoleVo(@NotNull SecurityRole securityRole) {
        if (null == securityRole || securityRole.isEmpty()) {
            return null;
        }
...
//    }
     ...
     * @Description 数据 ID.
     *
     * @Design {@link Security.RoleVo#code}
     *
     * @see Security.RoleVo#code
     */
     ...
     *
     * @Description 可为空.
     * @Design {@link Security.RoleVo#description}
     * @see Security.RoleVo#description
     */
    @Column(length = 200)
