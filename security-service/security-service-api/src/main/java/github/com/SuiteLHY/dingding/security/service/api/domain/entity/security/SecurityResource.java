...
public class SecurityResource
     ...
     *
     * @Solution
     * · {@linkplain <a href="https://stackoverflow.com/questions/56497893/org-springframework-aop-aopinvocationexception-null-return-value-from-advice-do">java - org.springframework.aop.AopInvocationException: Null return value from advice does not match primitive return type for: public abstract char - Stack Overflow</a> 持久化映射字段及其 getter 方法 (通常情况下) 不应该使用原始类型.}
     */
    @Column(nullable = false, length = 20)
...
//    }
    ...
    public enum Factory
         ...
         * @throws IllegalArgumentException
         */
        public @NotNull SecurityResource update(@NotNull SecurityResource oldEntity, @NotNull SecurityResource newEntity)
                throws IllegalArgumentException
        {
         ...
         */
        @Override
        public @NotNull SecurityResource createDefault() {
    ...
    public @NotNull Resource.TypeVo getType() {
        return type;
    }
    ...
    public @NotNull /*int*/Integer getSort() {
        return sort;
    }
