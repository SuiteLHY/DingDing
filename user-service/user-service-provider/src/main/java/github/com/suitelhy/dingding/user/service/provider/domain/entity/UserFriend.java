...
public class UserFriend
    ...
    protected boolean validateId(@NotNull String id) {
        return Validator.USER.entity_id(this.id);
    }

    //===== EntityValidator =====//

    enum Validator
            implements EntityValidator<UserFriend, String> {
        ...
        public boolean friendUserId(String friendUserId) {
            ...
            return User.Validator.USER.userid(friendUserId);
        }
    ...
    public enum Factory
            implements EntityFactoryModel<UserFriend> {
        USER_FRIEND;
         ...
         */
        @Override
        public @NotNull UserFriend createDefault() {
