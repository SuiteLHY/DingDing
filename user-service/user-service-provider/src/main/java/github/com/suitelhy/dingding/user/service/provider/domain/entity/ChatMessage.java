...
import github.com.suitelhy.dingding.core.infrastructure.domain.vo.Message;
...
public class ChatMessage
    ...
    public enum Validator
            implements EntityValidator<ChatMessage, String> {
    ...
    public enum Factory
            implements EntityFactoryModel<ChatMessage> {
        CHAT_MESSAGE;
         ...
         */
        @Override
        public @NotNull ChatMessage createDefault() {
