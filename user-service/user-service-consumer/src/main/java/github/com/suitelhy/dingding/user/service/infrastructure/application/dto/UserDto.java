package github.com.suitelhy.dingding.user.service.infrastructure.application.dto;
...
public class UserDto
     ...
     * }
     */
    private final transient @NotNull Map<String, Object> dtoIdExtension;
     ...
     */
    public @Nullable User dtoId(@NotNull String username, @NotNull String passwordPlaintext) {
     ...
     * @return The unique identify of the DTO, or null.
     */
    public @Nullable User dtoId(@NotNull User dtoId) {
        if (null == dtoId
                || dtoId.isEmpty()
...
//    }
     ...
     * @return [用户 -> 账户操作基础记录]
     */
    public @Nullable UserAccountOperationInfo dtoId_UserAccountOperationInfo(@NotNull User dtoId) {
        if (null == dtoId || ! this.dtoId.equals(dtoId)) {
            return null;
        }
     ...
     * @return [用户 -> 个人信息]
     */
    public @Nullable UserPersonInfo dtoId_UserPersonInfo(@NotNull User dtoId) {
        if (null == dtoId || ! this.dtoId.equals(dtoId)) {
            return null;
        }
    ...
    public @NotNull String toJSONString() {
        return String.format("{\"username\":\"%s\",\"age\":\"%s\",\"registrationTime\":\"%s\",\"nickname\":\"%s\",\"introduction\":\"%s\",\"faceImage\":\"%s\",\"sex\":\"%s\",\"status\":\"%s\"}"
                , this.username
                , this.age
    ...
    public enum Factory
         ...
         */
        public @NotNull UserDto create(@Nullable Integer age
        ...
        {
            final @NotNull User user = User.Factory.USER.create(username, password);
            final @NotNull UserAccountOperationInfo userAccountOperationInfo = UserAccountOperationInfo.Factory.USER.create(username
                    , ip
                    , lastLoginTime
                    , registrationTime);
            final @NotNull UserPersonInfo userPersonInfo = UserPersonInfo.Factory.USER.create(username
                    , nickname
                    , age
                    , faceImage
                    , introduction
         ...
         * @return {@link UserDto}
         */
        public @NotNull UserDto create(@NotNull User user, @NotNull UserAccountOperationInfo userOperationInfo, @NotNull UserPersonInfo userPersonInfo)
                throws IllegalAccessException
        {
...
//        }
         ...
         * @throws IllegalAccessException
         */
        public @NotNull UserDto update(@NotNull User user, @NotNull UserAccountOperationInfo userAccountOperationInfo, @NotNull UserPersonInfo userPersonInfo)
                throws IllegalAccessException
        {
         ...
         * @throws IllegalArgumentException 此时 <param>id</param> 非法
         */
        public @NotNull UserDto update(@NotNull String id
                ...
                throws IllegalAccessException
        {
            ...
            final @NotNull User user = User.Factory.USER.update(id, username, password);
            final @NotNull UserAccountOperationInfo userAccountOperationInfo = UserAccountOperationInfo.Factory.USER.create(username
                    , ip
                    , lastLoginTime
                    , registrationTime);
         ...
         */
        @Override
        public @NotNull UserDto createDefault() {
            return new UserDto();
        }
