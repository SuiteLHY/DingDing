...
public class BasicUserDto
    ...
    protected BasicUserDto(@NotNull BasicUserDto basicUserDto)
            throws IllegalArgumentException
    {
        if (null == basicUserDto || ! basicUserDto.isDtoLegal()) {
    ...
    public enum Factory
         ...
         * 更新用户 DTO
         *
         * @param id        {@linkplain User.Validator#userid(String) 用户 ID}
         * @param username  {@linkplain User.Validator#username(String) 用户名称}
         * @param password  {@linkplain User.Validator#password(String) 用户 - 密码}
         *
         * @return {@link BasicUserDto}
         *
         * @throws IllegalArgumentException 此时 <param>id</param> 非法
         */
        public @NotNull BasicUserDto update(@NotNull String id, @NotNull String username, @NotNull String password)
                throws IllegalArgumentException
        {
         ...
         * @return
         * {
         *  {@literal true}: <b>销毁成功</b>,
         *  {@literal false}: <b>销毁失败, 此时 {@param userDto} 无效或无法销毁</b>
         * }
         */
