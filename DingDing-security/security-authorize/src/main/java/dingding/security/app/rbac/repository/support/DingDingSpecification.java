 ...
 * 
 */
package dingding.security.app.rbac.repository.support;
 ...
 *
 */
public abstract class DingDingSpecification<T, C> extends AbstractEventConditionBuilder<T, C>
		implements Specification<T> {

	/**
	 * @param condition
	 */
	public DingDingSpecification(C condition) {
		super(condition);
	}
