package dingding.security.app.rbac.init;
...
import dingding.security.app.rbac.domain.ResourceType;
...
//		createResource("资源管理", "authorization", "", menu1);
