...
//服务配置
	...
	config.moveUp = {url:"authorization/:id/up", method:"POST"};
	config.moveDown = {url:"authorization/:id/down", method:"POST"};
	return $resource("authorization/:id", {id:"@id"}, config);
	...
	roleRestServiceSetting.updateRoleMenus = {method: "POST", url: "role/:id/authorization?ids=:ids"};
	roleRestServiceSetting.getRoleMenus = {method: "GET", url: "role/:id/authorization", isArray: true};
