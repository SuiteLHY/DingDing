 ...
 *
 */
package dingding.security.core.social.support;
 ...
 *
 */
public class DingDingSpringSocialConfigurer extends SpringSocialConfigurer {

    private String filterProcessesUrl;

    private SocialAuthenticationFilterPostProcessor socialAuthenticationFilterPostProcessor;

    public DingDingSpringSocialConfigurer(String filterProcessesUrl) {
