...
public class ChatHandler
     ...
     *
     * @API <a href="https://netty.io/4.1/api/io/netty/channel/group/ChannelGroup.html">ChannelGroup（Netty API参考（4.1.45.Final））</a>
     ...
     * @param ctx
     * @throws Exception
     * @Description 当客户端连接服务端之后（打开连接）, 将客户端的 Channel 添加到 ChannelGroup 中进行管理.
     */
    @Override
